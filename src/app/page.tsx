...
export default function Home() {
  ...
  const endpoints = [
    ...
    { name: 'Gemini', url: '/api/gemini', headers: { 'Content-Type': 'application/json' }, bodyIsJson: true },
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    endpoints.forEach(async (endpoint) => {
        ...
        try {
            ...
            const html = result.json || result.html || result.response || 'Unable to generate answer from this source. Results will be available from other sources shortly';
